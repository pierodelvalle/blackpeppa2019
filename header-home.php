...
<head>
	...
	<meta property="og:image" content="<?= get_template_directory_uri(); ?>/img/foto-meta.jpg">
	...
	<meta property="twitter:image" content="<?= get_template_directory_uri(); ?>/img/foto-meta.jpg">
	<!-- Rest of stuff -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<?php wp_head(); ?>
	<!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css">-->
	<link href="https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/3.0.4/fullpage.min.css" rel="stylesheet">
